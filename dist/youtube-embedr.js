(function() {
  ...
  YoutubeEmbedr.prototype.addLightbox = function() {
    var that = this

    if (that.elem.attr('data-toggle') === 'lightbox') {
      that.elem.attr('href', 'https://www.youtube.com/watch?v=' + that.getId() + '')
    }
  }
